...
static void print_wake_reason()
{
    ...
    Serial.printf("[TokenSlate] wake cause: %d\n", (int)cause);
...
static void go_to_sleep()
{
    ...
    /* Both buttons are active-low (pulled up, pressed = LOW), so use
     * ALL_LOW. ANY_HIGH would wake immediately since GPIO0 idles HIGH. */
